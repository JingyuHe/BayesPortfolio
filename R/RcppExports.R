...
rmultireg_IG_multirun <- function(Y, X, betabar_all, A, nu, beta_mat, sigmasq_vec) {
    invisible(.Call(`_BayesPortfolio_rmultireg_IG_multirun`, Y, X, betabar_all, A, nu, beta_mat, sigmasq_vec))
}
