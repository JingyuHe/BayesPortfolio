...
Rcpp::List runiregGibbs(vec const& y, mat const& X, vec const& betabar, mat const& A, double nu, double ssq, 
...
Rcpp::List runireg_singlerun(arma::vec const& y, arma::mat const& X, arma::vec const& betabar, arma::mat const& A, double nu, double ssq);
