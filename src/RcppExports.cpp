...
RcppExport SEXP bayesm_rsurGibbs_hierarchical_rcpp_loop(SEXP regdataSEXP, SEXP indregSEXP, SEXP cumnkSEXP, SEXP nkSEXP, SEXP XspXsSEXP, SEXP SigmainvSEXP, SEXP ASEXP, SEXP AbetabarSEXP, SEXP nuSEXP, SEXP VSEXP, SEXP nvarSEXP, SEXP ESEXP, SEXP YSEXP, SEXP RSEXP, SEXP keepSEXP, SEXP nprintSEXP) {
BEGIN_RCPP
...
static const R_CallMethodDef CallEntries[] = {
    {"bayesm_rsurGibbs_hierarchical_rcpp_loop", (DL_FUNC) &bayesm_rsurGibbs_hierarchical_rcpp_loop, 16},
    {NULL, NULL, 0}
};
